...
public class MenuControllerTest {
    ...
    public void checkSaladAdd() {
        ...
        Vegetable[] vegetables = new Vegetable[]{
                new Vegetable("Apple", VegetableColorCategory.RED, RipenessPercentage.RIPE, 100, 100),
                new Vegetable("Banana", VegetableColorCategory.YELLOW, RipenessPercentage.RIPE, 150, 100)
        };
    ...
    public void checkSortByName() {
        ...
        Vegetable[] vegetables = new Vegetable[]{
                new Vegetable("Banana", VegetableColorCategory.YELLOW, RipenessPercentage.RIPE, 150, 100),
                new Vegetable("Cucumber", VegetableColorCategory.GREEN, RipenessPercentage.RIPE, 30, 100),
                new Vegetable("Apple", VegetableColorCategory.RED, RipenessPercentage.RIPE, 100, 100),

        };
        saladModel.addVegetables(vegetables);

        assertArrayEquals(new Vegetable[]{new Vegetable("Apple", VegetableColorCategory.RED, RipenessPercentage.RIPE, 100, 100),
                        new Vegetable("Banana", VegetableColorCategory.YELLOW, RipenessPercentage.OVERRIPE, 150, 100),
                        new Vegetable("Cucumber", VegetableColorCategory.GREEN, RipenessPercentage.RIPE, 30, 100)},
                saladModel.sortBy("name"));
    }
